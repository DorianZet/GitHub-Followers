...
class GFEmptyStateView: UIView {
    ...
    private func configure() {
        ...
        NSLayoutConstraint.activate([
            ...
            logoImageView.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: 40) // similarly to the above constraint, this constant is not negative, as we want to push the picture below to the main view.
        ])
    }
}
